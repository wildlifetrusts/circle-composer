 ...
 *   handlers = {
 *     "storage" = "Drupal\wildlife_location\LocationStorage",
 *     "view_builder" = "Drupal\Core\Entity\EntityViewBuilder",
 *     "list_builder" = "Drupal\wildlife_location\LocationListBuilder",
 *     "views_data" = "Drupal\views\EntityViewsData",
 *     "translation" = "Drupal\wildlife_location\LocationTranslationHandler",
 *
 *     "form" = {
 *       "default" = "Drupal\wildlife_location\Form\LocationForm",
 *       "add" = "Drupal\wildlife_location\Form\LocationForm",
 *       "edit" = "Drupal\wildlife_location\Form\LocationForm",
 *       "delete" = "Drupal\wildlife_location\Form\LocationDeleteForm",
 *     },
 *     "access" = "Drupal\wildlife_location\LocationAccessControlHandler",
 *     "route_provider" = {
 *       "html" = "Drupal\wildlife_location\LocationHtmlRouteProvider",
 *     },
 *   },
 *   base_table = "location",
 ...
 * )
 */
class Location extends RevisionableContentEntityBase implements LocationInterface {
  ...
  public function preSave(EntityStorageInterface $storage) {
    ...
    // If no revision author has been set explicitly, make the location owner the
    // revision author.
  ...
  public static function baseFieldDefinitions(EntityTypeInterface $entity_type) {
    ...
    $fields['name'] = BaseFieldDefinition::create('string')
      ...
      ->setDescription(t('A name for the location which will make it easy to identify when referencing it from an Event or Job etc.'))
      ->setRevisionable(TRUE)
      ->setTranslatable(TRUE)
      ->setSettings([
        'text_processing' => 0,

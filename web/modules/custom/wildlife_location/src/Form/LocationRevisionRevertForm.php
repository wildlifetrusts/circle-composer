...
class LocationRevisionRevertForm extends ConfirmFormBase {
   ...
   *
   * @var \Drupal\wildlife_location\Entity\LocationInterface
   */
  protected $revision;
  ...
  /**
   * Constructs a new LocationRevisionRevertForm.
   *
  ...
  public function __construct(EntityStorageInterface $entity_storage, DateFormatterInterface $date_formatter) {
    $this->locationStorage = $entity_storage;
  ...
  public static function create(ContainerInterface $container) {
    return new static(
      $container->get('entity.manager')->getStorage('location'),
  ...
  public function submitForm(array &$form, FormStateInterface $form_state) {
    ...
    drupal_set_message(t('Location %title has been reverted to the revision from %revision-date.', ['%title' => $this->revision->label(), '%revision-date' => $this->dateFormatter->format($original_revision_timestamp)]));
   ...
   *
   * @param \Drupal\wildlife_location\Entity\LocationInterface $revision
